...
describe("Callback", function()
  ...
  it("using call syntax on the callback triggers the callback", function()
    local c = callback:new()
    local s = spy.new(function() end)
    local f = spy_to_func(s)
    c:add(f)
  ...
  it("should lock the trigger list once it starts if new callbacks are added", function()
    local c = callback:new()
    local s = spy.new(function() end)
    local f = spy_to_func(s)
    local add_more = function() c:add(f) end
    c:add(add_more)
    c()
