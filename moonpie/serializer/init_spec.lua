...
describe("game.serializer", function()
  local serializer = require "moonpie.serializer"
  local MockLove = require "moonpie.test_helpers.mock_love"

  after_each(function()
    MockLove.reset(love.filesystem, "write")
    MockLove.reset(love.filesystem, "read")
  end)
  ...
  it("can deserialize data from a file", function()
    local binser = require "moonpie.ext.binser"
