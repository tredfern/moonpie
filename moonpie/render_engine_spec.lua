...
describe("RenderEngine", function()
  ...
  describe("Paint", function()
    it("paints all the layers", function()
      local ui = RenderEngine.render_all("ui", Component.complex())
      local debug = RenderEngine.render_all("debug", Component.complex())
      local floating = RenderEngine.render_all("floating", Component.complex())
